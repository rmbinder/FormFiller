...
switch($getMode)
{
	case 1:
    	...
    	// show form
    	$form = new HtmlForm('export_form', ADMIDIO_URL .'/adm_plugins/'.$plugin_folder.'/export_import.php?mode=2', $page);
    	...
    	// show form
    	$form = new HtmlForm('import_form', ADMIDIO_URL .'/adm_plugins/'.$plugin_folder.'/export_import.php?mode=3', $page, array('enableFileUpload' => true));
