<form {foreach $attributes as $attribute}
   ...
   <div class="card admidio-field-group">
        <div class="card-header">{$l10n->get('PLG_FORMFILLER_ACCESS_ROLE')}</div>
        <div class="card-body">
        ...
        <div class="card admidio-field-group">
        <div class="card-header">{$l10n->get('PLG_FORMFILLER_MENU_ITEM')}</div>
        <div class="card-body">   
    ...
    <div class="card admidio-field-group">
        <div class="card-header">{$l10n->get('PLG_FORMFILLER_CONFIG_DATA')}</div>
        <div class="card-body"> 
